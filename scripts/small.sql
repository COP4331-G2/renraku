# Create Users Table
CREATE TABLE `innodb`.`Users` ( `ID` INT NOT NULL AUTO_INCREMENT , `Username` VARCHAR(50) NOT NULL DEFAULT '' , `Password` VARCHAR(50) NOT NULL DEFAULT '' , PRIMARY KEY (`ID`)) ENGINE = InnoDB;

CREATE TABLE `innodb`.`Contacts` ( `ID` INT NOT NULL AUTO_INCREMENT , `FirstName` VARCHAR(50) NOT NULL DEFAULT '' , `LastName` VARCHAR(50) DEFAULT '' , `PhoneNumber` BIGINT , `EmailAddress` VARCHAR(50) NOT NULL DEFAULT '' , `UserID` INT NOT NULL , FOREIGN KEY (`UserID`) REFERENCES Users(`ID`), PRIMARY KEY (`ID`)) ENGINE = InnoDB;
